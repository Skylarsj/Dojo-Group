...
const EarnEasy = () => {
  ...
  return (
    <div>
      ...
      {gameOver && (
        <button href="/MediumShop" className="bg-green-500 hover:bg-blue-100 text-white font-bold py-2 px-4 rounded block" style={{ position: 'absolute', bottom: 160 , left: 90 }} onClick={handleShop}>
          Go to Medium Shop
        </button>
      )}
    </div>
