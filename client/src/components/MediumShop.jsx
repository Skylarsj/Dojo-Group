      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="box">
            ...
            <div className="text-lg font-bold text-White ml-2 " style={{ textShadow: '2px 2px 2px #000' }}>{`50 Score`}</div>
            <button className="bg-green-500 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded ml-3 " onClick={handleBuyPokeball}>Buy</button>
          ...
          <div className="box">
            ...
            <button className="bg-green-500 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded ml-3 mt-2" onClick={handleBuyGreatBall}>Buy</button>
          ...
          <div className="box">
            ...
            <button className="bg-green-500 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded ml-4 mt-2" onClick={handleBuyUltraBall}>Buy</button>
